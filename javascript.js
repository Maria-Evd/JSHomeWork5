...
// Задание 2
// Необходимо из объекта, который лежит в константе
// post вывести значения, к которым приписан комментарий, в консоль.
...
// const productsPhotosTrue = products.filter(product => product.photos && product.photos.length > 0);
// console.log(productsPhotosTrue);
